...
- `utils/`: shared functions for batch correction, benchmarking, differential analysis, imputation, and figure styling.
...
| `data/protein_profiles_long.tsv.gz` | Harmonized long-format protein abundance profiles across platforms, batches, samples, and processing levels. |
| `data/feature_metadata.tsv.gz` | Harmonized assay-feature, target, and UniProt annotations. |
